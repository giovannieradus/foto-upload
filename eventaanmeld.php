...
<script>
         function readURL(input) {
            if (input.files && input.files[0]) {
                ...
                document.getElementById("foto1").style.maxWidth = "200px";
            document.getElementById("foto1").style.maxHeight = "1000px";
        }
...
<img src="Img/download.png" width="300px" height="300px" id="foto1"  alt="your image" />
      ...
      <div class="col-md">
        <form method="POST" action="event_verwerk.php" enctype="multipart/form-data">
...
$sql = "SELECT Naam, ID_Event FROM `EVENT`";
